...
namespace Sudoko_wpf
{
    public class Puzzle
    {
        private static bool[,] initialCells;
        private static char[,] solvedPuzzle;
        private static string puzzleCode = "NO CODE YET";
        ...
        public static string GetCurrentCode() => puzzleCode;
        ...
        public static void ImportPuzzleCode(string puzzleCode)
        {
            int settingEnd = puzzleCode.IndexOf(":");
            int separator = puzzleCode.IndexOf(",");
            Settings.BOX_WIDTH = int.Parse(puzzleCode.Substring(0, separator));
            ...
            for (int i = 0; i < Settings.BOX_HEIGHT; i++)
            {
                for (int j = 0; j < Settings.BOX_WIDTH; j++)
                {
